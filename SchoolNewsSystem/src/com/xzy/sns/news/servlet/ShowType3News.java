...
@WebServlet("/showType3News")
public class ShowType3News extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<News> type3newes=service.showNews(pageNum, type);
		
		News news=new News();
	/*	Iterator<News> it=type3newes.iterator();
		while(it.hasNext()) {
		...
		session.setAttribute("type3newes", type3newes);
		session.setAttribute("page3", pageNum);
