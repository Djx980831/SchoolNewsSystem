...
@WebServlet("/showType4News")
public class ShowType4News extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<News> type4newes=service.showNews(pageNum, type);
		
		News news=new News();
	/*	Iterator<News> it=type4newes.iterator();
		while(it.hasNext()) {
		...
		session.setAttribute("type4newes", type4newes);
		session.setAttribute("page4", pageNum);
